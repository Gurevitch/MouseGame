...
- [] `[P1]` higgins walikng is showing only the first frame. also i want him to walk from 1266,750->1058,640
- [] `[P1]` in the rooms, pp is too small 
- [] `[P1]` it still hard to talk with danny and marcus 
- [] `[P1]` pp pick up the flower sprite is not in the same same as his idle. and he stack after pick up 